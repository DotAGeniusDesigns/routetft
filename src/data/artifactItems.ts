...
export const ARTIFACT_ITEMS: ArtifactItem[] = [
  ...
  { name: "Death's Defiance",         imageUrl: `${CDN}/tft4_item_ornndeathsdefiance.tft_set13.png` },
  { name: 'Gold Collector',           imageUrl: `${CDN}/tft4_item_ornnthecollector.tft_set13.png` },
  ...
  { name: "Sniper's Focus",           imageUrl: `${CDN}/tft_item_blank.tft_set13.png` },
